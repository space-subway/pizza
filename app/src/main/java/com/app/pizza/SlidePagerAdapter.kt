...
class SlidePagerAdapter(private val context: Context, private val imageList: List<Int>) : PagerAdapter() {
        ...
        override fun instantiateItem(container: ViewGroup, position: Int): Any {
                ...
                val imageView: ImageView = itemView.findViewById<View>(R.id.slide_image) as ImageView
